...
const ContactForm = () => {
    return (
      <div className="contact-page-container" style={{ padding: "2rem" }}>
        ...
        <FaHome style={{ fontSize: '24px', color: 'purple' , width : '70px' ,height : '70px' , marginLeft : '650px',marginTop : '30px',borderRadius : '40px' }} />
        <p style={{marginLeft : '650px' , fontSize : '25px', fontFamily : "sans-serif" , color : 'purple'}}>Address</p>
        </div>
    ...
    <div className="add-2" style={{ flex: 1, lineHeight: '1.6' }}>
        ...
        <div className="contact-form-wrapper" style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <form className="contact-form">
            ...
            <input type="tel" placeholder="Phone*" className="form-input" style={inputStyle} required />
            <input type="email" placeholder="Email*" className="form-input" style={inputStyle} required />
            <textarea placeholder="Message" className="form-textarea" style={textareaStyle}></textarea>
